...
I'm happy to discuss particular situations as prompted based on the material; I can modify the schedule on the fly easily.
...
For (most) content in single-page format, just see the [website](https://nimble-training.github.io/nimble-alaska-2026).

To download the files (including the slides versions of the modules), you can do any of the following. The slides versions are titled "<xyz>_slides.html".
...
We are hard at work on a complete overhaul of the internals of NIMBLE. This will achieve the following:

- streamlined representation of model nodes (think `y[1:1000]` not `y[1]`,`y[2]`,`y[3]`...):

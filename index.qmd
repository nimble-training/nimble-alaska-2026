...
Here are the modules we'll work through for this short course.
    ...
    - [2. Comparing and customizing MCMC](content/2_comparing_and_customizing_mcmc/comparing_and_customizing_mcmc.html)
    - [3. User-defined distributions and functions](content/3_user_defined/extending_models.html)
    - [4. Programming in NIMBLE](content/4_programming/nimblefunction_programming.html)
